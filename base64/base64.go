...
type Encoding struct {
	...
	decodeMap        [256]byte
	padChar          rune
	removeCharMapper func(r rune) rune
}
...
func NewEncoding(encoder string) *Encoding {
	...
	e.removeCharMapper = RemoveNewlinesMapper
...
// IgnoreChars creates a new encoding identical to enc except
// with a specified character removal mapper.
func (enc Encoding) IgnoreChars(f func(r rune) rune) *Encoding {
	enc.removeCharMapper = f
	return &enc
}
...
// RemoveNewlinesMapper strips the string of all newline characters.
...
// RemoveSpaceMapper strips the string of all Unicode space characters.
var RemoveSpaceMapper = func(r rune) rune {
...
// RemoveNonGraphicMapper strips the string of all Unicode non-graphic
// characters.
var RemoveNonGraphicMapper = func(r rune) rune {
...
func (enc *Encoding) DecodeString(s string) ([]byte, error) {
	s = strings.Map(enc.removeCharMapper, s)
